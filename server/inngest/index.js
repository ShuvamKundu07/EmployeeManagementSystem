...
const attendanceReminderCron = inngest.createFunction(
  { id: "attendance-reminder-cron", triggers: [{ cron: "0 0 0 6 * * *"}]},  // 06:00 UTC = 11:30 AM IST
  async ({step}) => {
    ...
    // Step 5: Filter absent employees (not on leave & checked in)
    ...
    return {totalActive: activeEmployees.length,
